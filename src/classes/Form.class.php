...
class qbWpListsForm
{
    ...
    /**
     * @var bool Is the form sent and all the inserted values are valid
     */
    public $valid = false;

    /**
     * @var bool Is the form sent
     */
    public $sent;
    ...
    public function validateField($id)
    {
        ...
        switch ($f['type']) {
            case 'antybot': case 'hidden':
                return strcmp(mb_strtolower($f['value']), mb_strtolower($f['expected'])) == 0;
            case 'checkbox':
